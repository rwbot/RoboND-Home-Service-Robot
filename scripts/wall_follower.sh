...
xterm -e "  roslaunch turtlebot_gazebo turtlebot_world.launch world_file:=/home/workspace/catkin_ws/src/worlds/uda.world" &
sleep 10
...
xterm -e "  export TURTLEBOT_3D_SENSOR=kinect; roslaunch turtlebot_navigation gmapping_demo.launch custom_gmapping_launch_file:=/home/workspace/catkin_ws/src/launch/custom_home_service_gmapping.launch" &
sleep 5
